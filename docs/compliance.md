...
| Fluxe B2B Suite | `audit.retention.cleanup` — execução do job de limpeza de audit log |
| Fluxe B2B Suite | `JWT_VERIFIED_WITH_PREVIOUS_KEY` — token verificado com chave anterior durante rotação de JWT_SECRET |
